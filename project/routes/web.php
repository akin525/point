...
Route::get('/edit/game/{id}','HomeController@edit_game')->name('edit_game') ;
Route::put('/edit/game/{id}','HomeController@update_game');
Route::get('/add/game','HomeController@add_game')->name('csm_add_game') ;
...
Route::get('/edit/visit/{id}','HomeController@edit_visit')->name('edit_visit') ;
Route::put('/edit/visit/{id}','HomeController@update_visit');
Route::get('/add/visit','HomeController@add_visit')->name('csm_add_visit') ;
...
Route::get('/edit/refer/{id}','HomeController@edit_refer')->name('edit_refer') ;
Route::put('/edit/refer/{id}','HomeController@update_refer');
Route::get('/add/refer','HomeController@add_refer')->name('csm_add_refer') ;
...
//Offerwalls
Route::get('/offerwalls','HomeController@offerwalls')->name('offerwalls') ;
Route::get('/edit/offerwall/{id}','HomeController@edit_offerwalls')->name('edit_offerwalls') ;
Route::put('/edit/offerwall/{id}','HomeController@update_offerwall');
//ads & videos
Route::get('/ads','HomeController@ads')->name('ads') ;
Route::get('/edit/ads/{id}','HomeController@edit_ads')->name('edit_ads') ;
Route::put('/edit/ads/{id}','HomeController@update_ads');
//settings
Route::get('/settings','HomeController@settings')->name('settings') ;
Route::get('/settings/fraud-prevention','HomeController@fraud_prevention_settings')->name('fraud_prevention') ;
Route::get('/app/settings','HomeController@csm_app_settings')->name('csm_app_settings') ;
...
//redeem requests
Route::get('/redeem-requests','HomeController@redeem')->name('redeem') ;
...
Route::get('/redeem/status/{id}','HomeController@redeem_status')->name('redeem_status') ;
//redeem methods
Route::get('/redeem-methods','HomeController@redeem_methods')->name('redeem_methods') ;
Route::get('/edit/redeem-method/{id}','HomeController@edit_rm')->name('edit_rm') ;
Route::put('/edit/redeem-method/{id}','HomeController@update_rm');
Route::get('/edit/redeem-amounts/{id}','HomeController@edit_rm_amounts')->name('edit_rm_amounts') ;
Route::post('/edit/redeem-amounts/{id}','HomeController@create_rm_amounts');
Route::get('/delete-amounts/{id}','HomeController@delete_rm_amounts')->name('delete_rm_amounts') ;
Route::get('/delete-redeem/{id}','HomeController@delete_rm')->name('delete_rm') ;
Route::get('/add/redeem-method','HomeController@add_rm_method')->name('add_rm_method') ;
Route::post('/add/redeem-method','HomeController@create_rm_method');
//trckers
Route::get('/tracker','HomeController@tracker')->name('tracker') ;
Route::get('/tracker/{id}','HomeController@tracker_u')->name('trackeru') ;
//Postbacks
...
Route::get('/send','HomeController@push') ;
Route::get('delete-noti/{id}','HomeController@csm_delete_noti')->name('csm_delete_noti');
//users routes
Route::get('users','HomeController@users')->name('users') ;
Route::get('user/search/{data}','HomeController@users_search')->name('users_search') ;
...
//users routes
Route::get('referrals','HomeController@t_referrals')->name('t_referrals') ;

//files
Route::get('resources', 'HomeController@file_resources')->name('file_resources') ;
Route::get('del-resources-file/{name}','HomeController@delete_file_resources')->name('del_file_resources') ;
...
Route::get('users/delete/requests','HomeController@usersdel_requests')->name('usersdel_requests') ;
